...
- **`frontend-design` skill** — invoke via the Skill tool (`frontend-design`), or read `~/.claude/skills/frontend-design/SKILL.md` directly. Load it before building any web UI. It encodes design tokens, component patterns, and styling constraints. Loading it is not optional for design work.
